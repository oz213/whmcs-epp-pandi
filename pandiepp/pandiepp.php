...
function pandiepp_MetaData()
{
    return array(
        'DisplayName' => 'PANDI EPP Module for WHMCS',
        'APIVersion' => '1.0',
    );
}

function _pandiepp_error_handler($errno, $errstr, $errfile, $errline)
{
	if (!preg_match("/pandiepp/i", $errfile)) {
		return true;
	}

	_pandiepp_log("Error $errno:", "$errstr on line $errline in file $errfile");
}

set_error_handler('_pandiepp_error_handler');
_pandiepp_log('================= ' . date("Y-m-d H:i:s") . ' =================');

function pandiepp_getConfigArray($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	_pandiepp_create_table();
	_pandiepp_create_column();
...
function _pandiepp_startEppClient($params = array())
{
	$s = new pandiepp_epp_client($params);
	$s->login($params['clid'], $params['pw'], $params['registrarprefix']);
	return $s;
}

function pandiepp_RegisterDomain($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
		$s = _pandiepp_startEppClient($params);
		$from = $to = array();
		$from[] = '/{{ name }}/';
...
function pandiepp_RenewDomain($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_TransferDomain($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_GetNameservers($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_SaveNameservers($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_GetRegistrarLock($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = 'unlocked';
	try {
...
function pandiepp_SaveRegistrarLock($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_GetContactDetails($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_SaveContactDetails($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_IDProtectToggle($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_GetEPPCode($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
";
		...
		if (!$mail->Send()) {
			_pandiepp_log(__FUNCTION__, $mail);
...
function pandiepp_RegisterNameserver($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_ModifyNameserver($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_DeleteNameserver($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_RequestDelete($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
 ...
 * @return array
 */
function pandiepp_manageDNSSECDSRecords($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
 ...
 * @return array
 */
function pandiepp_ClientAreaCustomButtonArray()
{
	$buttonarray = array(
...
function pandiepp_AdminCustomButtonArray($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
...
function pandiepp_OnHoldDomain($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_UnHoldDomain($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_TransferSync($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
function pandiepp_Sync($params = array())
{
	_pandiepp_log(__FUNCTION__, $params);
	$return = array();
	try {
...
<epp xmlns="urn:ietf:params:xml:ns:epp-1.0"
  ...
  <command>
	...
	function read()
	{
		...
		$xml = preg_replace('/></', ">\n<", $xml);
		_pandiepp_log('================= read =================', $xml);
		return $xml;
	}

	function write($xml, $action = 'Unknown')
	{
		_pandiepp_log('================= send-this =================', $this);
		_pandiepp_log('================= send =================', $xml);
		@fwrite($this->socket, pack('N', (strlen($xml) + 4)) . $xml);
		$r = $this->read();
		_pandiepp_modulelog($xml, $r, $action);
...
function _pandiepp_modulelog($send, $responsedata, $action)
{
	$from = $to = array();
	$from[] = "/<clID>[^<]*<\/clID>/i";
	...
	logModuleCall('pandiepp',$action,$sendforlog,$responsedata);
}
...
function _pandiepp_create_table()
{
...
function _pandiepp_create_column()
{
